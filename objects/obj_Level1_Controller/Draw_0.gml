...
draw_sprite_ext(pl_fairy, 0, bria_x, bria_y, 1, 1, 0, c_white, 1);
...
var face_frame = (data.s == "Addeline") ? 0 : 0; // Adjust based on your portrait sprite
...
// "Next" Prompt (only show if line is finished typing)
