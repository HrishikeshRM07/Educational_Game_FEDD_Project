...
if (all_dead && attack_timer <= 0 && battle_state == BattleState.PLAYER_MENU) {
    if (current_wave < max_waves) {
        if (win_timer == -1) { win_timer = 120; fairy_text = "Well done! Get ready for the next wave!"; }
        ...
        if (win_timer == 0) {
            ...
            if (current_wave == 2) {
                enemies = [ 
                    ["GoldmanTall", 60, room_width-252, 840, GoldmanTall, 0, 1.0, c_white, 0.0], 
                    ["GoldmanTall", 60, room_width-448, 740, GoldmanTall, 0, 1.0, c_white, 0.0], // <-- CHANGE THIS NUMBER (was 714)
                    ["GoldmanShort", 30, room_width-644, 840, GoldmanShort, 0, 1.0, c_white, 0.0] 
                ];
            } else if (current_wave == 3) {
                enemies = [ 
                    ["Parabolate", 30, room_width-252, 840, Parabolate, 0, 1.0, c_white, 0.0], 
                    ["GoldmanTall", 60, room_width-448, 740, GoldmanTall, 0, 1.0, c_white, 0.0], // <-- CHANGE THIS NUMBER (was 714)
                    ["Ananan", 30, room_width-644, 840, Ananan, 0, 1.0, c_white, 0.0] 
                ];
            } else if (current_wave == 4) {
                enemies = [ 
                    ["Aundroid", 40, room_width-252, 840, Aundroid, 0, 1.0, c_white, 0.0], 
                    ["Aundroid", 40, room_width-448, 740, Aundroid, 0, 1.0, c_white, 0.0], // <-- CHANGE THIS NUMBER (was 840)
                    ["Aundroid", 40, room_width-644, 840, Aundroid, 0, 1.0, c_white, 0.0] 
                ];
            } else if (current_wave == 5) {
                enemies = [ 
                    ["Absarf", 30, room_width-252, 840, Absarf, 0, 1.0, c_white, 0.0], 
                    ["Absarf", 30, room_width-448, 740, Absarf, 0, 1.0, c_white, 0.0], // <-- CHANGE THIS NUMBER (was 840)
                    ["GoldmanTall", 60, room_width-644, 840, GoldmanTall, 0, 1.0, c_white, 0.0] 
                ];
            }
            win_timer = -1;
        }
        ...
        fairy_text = "You did it! All 5 waves are clear!";
        if (win_timer > 0) win_timer--;
