...
dialogue[0] = { t: "Excuse me! Are you one of the residents of this town?", s: "Fairy", spr: pl_fairy, port: spr_Addeline_Portraits };
dialogue[1] = { t: "Yes, but well… you can see what’s happened here.", s: "Addeline", spr: pl_ad, port: spr_Addeline_Portraits };
dialogue[2] = { t: "Yes! I’m here to find those with mathemagical abilities!", s: "Fairy", spr: pl_fairy, port: spr_Addeline_Portraits };
dialogue[3] = { t: "Dear citizen, are you OK? This.. creature needs to go back!", s: "Horatio", spr: pl_enemy, port: spr_Addeline_Portraits }; 
dialogue[4] = { t: "Don’t listen to him Addeline! Just give it a try with me!", s: "Fairy", spr: pl_fairy, port: spr_Addeline_Portraits };
