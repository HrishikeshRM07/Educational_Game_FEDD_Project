...
dialogue[2] = { t: "Addeline that was amazing! You really are a skilled warrior.", s: "Fairy", spr: Bria, port: spr_Addeline_Portraits };
dialogue[3] = { t: "King Phi has been trying to gain more mathemagical powers, but it’s had some pretty damaging results.", s: "Fairy", spr: Bria, port: spr_Addeline_Portraits };
dialogue[4] = { t: "My sibling and I tried to stop him but he captured both of us! So what do you say, will you help us?", s: "Fairy", spr: Bria, port: spr_Addeline_Portraits };
