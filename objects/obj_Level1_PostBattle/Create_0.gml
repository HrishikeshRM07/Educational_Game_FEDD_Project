...
dialogue[2] = { t: "King Phi has wanted power for a long time, and he\u0027s willing to go to any length in order to get it.", s: "Bria", spr: pl_fairy, port: BriaDialogue, f: 2 };
